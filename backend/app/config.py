...
DB_CONNECT_TIMEOUT = _float_env("DB_CONNECT_TIMEOUT", 3.0)
LOOKUP_AUTO_INSERT_IOC = _bool_env("LOOKUP_AUTO_INSERT_IOC", True)
LOOKUP_DB_WRITE_TIMEOUT = _float_env("LOOKUP_DB_WRITE_TIMEOUT", 1.5)
